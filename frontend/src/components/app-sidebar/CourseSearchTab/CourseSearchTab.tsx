...
const ALL_FILTERS = [
  ...
  { id: "hass:HASS-A", label: "HASS: A", category: "HASS" },
  { id: "hass:HASS-S", label: "HASS: S", category: "HASS" },
  { id: "hass:HASS-H", label: "HASS: H", category: "HASS" },
  { id: "hass:HASS-E", label: "HASS: E", category: "HASS" },
