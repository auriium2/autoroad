...
OBJECTIVES_REGISTRY: dict[str, ObjectiveMetadata] = {
    ...
    "avoid_special_classes": ObjectiveMetadata(
        ...
        description="Discourages automatic placement of Concourse/STS/ES/Research/Thesis classes. These should be added manually (use markers), since you should not let a machine tell you when to do your thesis.",
        has_parameters=False,
        default_parameters={},
        parameter_types={},
        category="scheduling",
    ...
    "avoid_special_topics": ObjectiveMetadata(
        ...
        description="Discourages automatic placement of special topics courses like 6.S040 or 18.S097. These are typically experimental one-off courses that may not be offered regularly, so you should use markers to place them.",
        has_parameters=False,
        default_parameters={},
        parameter_types={},
        category="scheduling",
