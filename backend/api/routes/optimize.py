...
async def event_stream(request: OptimizationRequest):
    try:
        ...
        if result == cp_model.FEASIBLE:
            ...
            warnings.append("No feasible solution found. Markers or constraints may be too strict. If this should be feasible, please report this!")
